...
$$.initWebSocket_anon0 = {"":
 ["box_0", "retrySeconds_2"],
 super: "Closure",
 $call$1: function(e) {
  $.outputMsg('web socket closed, retrying in ' + $.S(this.retrySeconds_2) + ' seconds');
  if (this.box_0.encounteredError_1 !== true) {
    var t1 = $.window();
    var t2 = new $.initWebSocket_anon4(this.retrySeconds_2);
...
$$.initWebSocket_anon4 = {"":
 ...
 super: "Closure",
 $call$0: function() {
  return $.initWebSocket($.mul(this.retrySeconds_3, 2));
 }
};

$$.initWebSocket_anon1 = {"":
 ["box_0", "retrySeconds_4"],
 super: "Closure",
 $call$1: function(e) {
  $.outputMsg('Error connecting to ws');
  if (this.box_0.encounteredError_1 !== true) {
    var t1 = $.window();
    var t2 = new $.initWebSocket_anon3(this.retrySeconds_4);
    var t3 = this.retrySeconds_4;
    if (typeof t3 !== 'number') throw $.iae(t3);
    t1.setTimeout$2(t2, 1000 * t3);
  }
  this.box_0.encounteredError_1 = true;
...
$$.initWebSocket_anon3 = {"":
 ...
 super: "Closure",
 $call$0: function() {
  return $.initWebSocket($.mul(this.retrySeconds_5, 2));
 }
};
...
$$.initWebSocket_anon2 = {"":
 ...
 super: "Closure",
 $call$1: function(e) {
  $.outputMsg('received message ' + $.S(e.get$data()));
 }
};
...
$.initWebSocket = function(retrySeconds) {
  ...
  $.ws = $._WebSocketFactoryProvider_WebSocket('ws://echo.websocket.org');
  $.add$1($.ws.get$on().get$open(), new $.initWebSocket_anon());
  $.add$1($.ws.get$on().get$close(), new $.initWebSocket_anon0(t1, retrySeconds));
  $.add$1($.ws.get$on().get$error(), new $.initWebSocket_anon1(t1, retrySeconds));
  $.add$1($.ws.get$on().get$message(), new $.initWebSocket_anon2());
};
